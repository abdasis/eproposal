                ...
                <div class="card-body">
                    <form wire:submit.prevent='store'>
                        ...
                        <div class="row">
                                    ...
                                    <select class="custom-select shadow-none" wire:model='nomor_kegiatan' required>
                                        ...
                                        {{-- @if ($noKegiatans)
                                                @foreach ($noKegiatans as $key => $no)
                                                    <option value="{{ $key+1 }}">{{ $key+1 }} - {{ $no->kegiaatan }}
                                        </option>
                                        @endforeach
                                        @endif --}}
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" wire:model="jadwal_pelaksanaan" id="jadwal_pelaksanaan"
                                        class="form-control shadow-none" placeholder="" aria-describedby="helpId">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" wire:model="judul_kegiatan" class="form-control shadow-none"
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control shadow-none" wire:model="penanggung_jawab" id=""
                                rows="3"></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control shadow-none" wire:model="sumber_daya" id=""
                                rows="3"></textarea>
                            <small class="text-muted">Pisahkan dengan koma (,) apabila terdapat banyak sumber
                                daya</small>
                        </div>
                    ...
                    <table class="table table-sm table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button wire:click='delete({{ $subkegiatan->id }})'
