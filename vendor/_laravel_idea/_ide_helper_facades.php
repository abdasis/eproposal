...
namespace Sentry\Laravel {
    ...
    /**
     * @see \Sentry\State\HubInterface::getClient
     * @method static null|\Sentry\ClientInterface getClient()
     * @see \Sentry\State\HubInterface::getTransaction
     * @method static null|\Sentry\Tracing\Transaction getTransaction()
     * @see \Sentry\State\HubInterface::captureLastError
     * @method static null|\Sentry\EventId captureLastError()
     * @see \Sentry\State\HubInterface::getIntegration
     * @method static null|\Sentry\Integration\IntegrationInterface getIntegration(string $className)
     * @see \Sentry\State\HubInterface::startTransaction
     * @method static \Sentry\Tracing\Transaction startTransaction(\Sentry\Tracing\TransactionContext $context)
     * @see \Sentry\State\HubInterface::captureException
     * @method static null|\Sentry\EventId captureException(\Throwable $exception)
     * @see \Sentry\State\HubInterface::captureMessage
     * @method static null|\Sentry\EventId captureMessage(string $message, null|\Sentry\Severity $level = null)
     * @see \Sentry\State\HubInterface::setSpan
     * @method static \Sentry\State\HubInterface setSpan(null|\Sentry\Tracing\Span $span)
     * @see \Sentry\State\HubInterface::addBreadcrumb
     * @method static bool addBreadcrumb(\Sentry\Breadcrumb $breadcrumb)
     * @see \Sentry\State\HubInterface::configureScope
     * @method static void configureScope(callable $callback)
     * @see \Sentry\State\HubInterface::getSpan
     * @method static null|\Sentry\Tracing\Span getSpan()
     * @see \Sentry\State\HubInterface::withScope
     * @method static void withScope(callable $callback)
     * @see \Sentry\State\HubInterface::popScope
     * @method static bool popScope()
     * @see \Sentry\State\HubInterface::captureEvent
     * @method static null|\Sentry\EventId captureEvent(\Sentry\Event $event, null|\Sentry\EventHint $hint = null)
     * @see \Sentry\State\HubInterface::bindClient
     * @method static void bindClient(\Sentry\ClientInterface $client)
     * @see \Sentry\State\HubInterface::pushScope
     * @method static \Sentry\State\Scope pushScope()
     * @see \Sentry\State\HubInterface::getLastEventId
     * @method static null|\Sentry\EventId getLastEventId()
     */
    class Facade {}
}
